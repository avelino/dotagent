...
* Preflight
  * [preflight-cmd](plugins/preflight-cmd.md)
  * [preflight-warp](plugins/preflight-warp.md)
* Sink
...
* [FAQ](faq.md)
* [LLM digest (`llms.txt`)](llms.txt) — single-page reference for LLM agents writing dotagent manifests
